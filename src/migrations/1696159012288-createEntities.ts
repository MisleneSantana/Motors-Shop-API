...
export class CreateEntities1696159012288 implements MigrationInterface {
    name = 'CreateEntities1696159012288'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "announcements" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "brand" character varying(15) NOT NULL, "model" character varying(20) NOT NULL, "year" character varying NOT NULL, "fuel" character varying(15) NOT NULL, "km" integer NOT NULL, "color" character varying(15) NOT NULL, "table_price" numeric(9,2) NOT NULL DEFAULT '0', "price" numeric(9,2) NOT NULL DEFAULT '0', "description" text, "announcement_is_active" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "PK_b3ad760876ff2e19d58e05dc8b0" PRIMARY KEY ("id"))`);
