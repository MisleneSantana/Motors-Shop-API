...
export class CreateEntities1696007339439 implements MigrationInterface {
    name = 'CreateEntities1696007339439'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(50) NOT NULL, "email" character varying(45) NOT NULL, "cpf" character varying(11) NOT NULL, "phone_number" character varying(12) NOT NULL, "birth_date" date NOT NULL, "description" text, "account_type" "public"."users_account_type_enum" NOT NULL DEFAULT 'buyer', "password" character varying(120) NOT NULL, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_230b925048540454c8b4c481e1c" UNIQUE ("cpf"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
